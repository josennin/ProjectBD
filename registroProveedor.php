				...
				<div class="box container" >
					<section>
						<header>
							...
							$sql = "insert into PROVEEDORES (NOMBRE_PROVEEDOR, EMAIL_PROVEEDOR, DESCUENTO,TELEFONO_PROVEEDOR,AÑOS_SERVICIOS) values 
							('".$_POST["nombre"]."','".$_POST["email"]."','".$_POST["descuentos"]."','".$_POST["telefono"]."','".$_POST["añosServicio"]."');";
	
							$stmt = sqlsrv_query( $conn, $sql );
							if( $stmt === false) {
								echo "Error al agregar el Proveedor"+print_r( sqlsrv_errors(), true);
							}else{
								echo "Se agrego el Proveedor";
							}
