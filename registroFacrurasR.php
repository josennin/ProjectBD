		...
		<!-- Main -->
			<div id="main">
				...
				<div class="box container" >
					<section>
						<header>
							<h1>Registro de Factura de Reparacion</h1>
							<?php
							include('sqlServer/conexionP.php');

							$hoy = date(DATE_RFC2822);
						
							$sql = "INSERT into FACTURA_REPARACION (FECHA_FRACTURAR, DESCRIPCION_FACTURAR, IMPUESTO,MONTOTOTAL_FACTURAR) values 
							('".$hoy."','".$_POST["descripcion"]."','".$_POST["impuesto"]."','".$_POST["montTotal"]."');";
	
							$stmt = sqlsrv_query( $conn, $sql );
							if( $stmt === false) {
								echo "Error al agregar la Factura de Reparacion"+print_r( sqlsrv_errors(), true);
							}else{
								echo "Se agrego la Factura de Reparacion correctamente";
							}
