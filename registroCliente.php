				...
				<div class="box container" >
					<section>
						<header>
							...
							('".$_POST["cedula"]."','".$_POST["nombre"]."','".$_POST["apellio"]."','".$_POST["email"]."','".$_POST["telefono"]."','".$_POST["direccion"]."');";
	
							$stmt = sqlsrv_query( $conn, $sql );
							if( $stmt === false) {
								echo "Error al agregar el cliente"+print_r( sqlsrv_errors(), true);
							}else{
								echo "Se agrego el cliente correctamente";
							}
