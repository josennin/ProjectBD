				...
				<div class="box container" >
					<section>
						<header>
							...
							$sql = "INSERT into USUARIOS (USERNAME, CONTRASEÑA, ROL) values 
							('".$_POST["username"]."','".$_POST["password"]."','".$_POST["rol"]."');";
	
							$stmt = sqlsrv_query( $conn, $sql );
							if( $stmt === false) {
								echo "Error al agregar el Usuario"+print_r( sqlsrv_errors(), true);
							}else{
