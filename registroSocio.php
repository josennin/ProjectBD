				...
				<div class="box container" >
					<section>
						<header>
							...
							$sql = "insert into socios (NOMBRE_SOCIOS, APELLIDOS_SOCIOS, EMAIL_SOCIOS,TELEFONO_SOCIOS,ACCIONES,INVERSIONES) values 
							('".$_POST["nombre"]."','".$_POST["apellido"]."','".$_POST["email"]."','".$_POST["telefono"]."','".$_POST["acciones"]."',".$_POST["inversion"].");";
	
							$stmt = sqlsrv_query( $conn, $sql );
							if( $stmt === false) {
								echo "Error al agregar el Socio"+print_r( sqlsrv_errors(), true);
							}else{
								echo "Se agrego el Socio correctamente";
							}
