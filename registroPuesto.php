		...
		<!-- Main -->
			<div id="main">
				...
				<div class="box container" >
					<section>
						<header>
							<h1>Registro de Puesto de trabajo</h1>
							<?php
							include('sqlServer/conexionP.php');
						
							$sql = "insert into PUESTOS_TRABAJO (NOMBRE_PUESTOT, DESCRIPCION_PUESTOT, HORAS_LABORALES) values 
							('".$_POST["nombre"]."','".$_POST["desscripcion"]."','".$_POST["horasLaborales"]."');";
	
							$stmt = sqlsrv_query( $conn, $sql );
							if( $stmt === false) {
								echo "Error al agregar el Puesto de trabajo"+print_r( sqlsrv_errors(), true);
							}else{
								echo "Se agrego el Puesto de trabajo correctamente";
							}
