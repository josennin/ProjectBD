				...
				<div class="box container" >
					<section>
						<header>
							...
							$sql = "insert into taller (ESPECIALIDAD,DIRECCION_TALLER, TELEFONO_TALLER) values 
							('".$_POST["especialidad"]."','".$_POST["direccion"]."','".$_POST["telefono"]."');";
	
							$stmt = sqlsrv_query( $conn, $sql );
							if( $stmt === false) {
								echo "Error al agregar el Taller"+print_r( sqlsrv_errors(), true);
							}else{
								echo "Se agrego el Taller correctamente";
							}
