		...
		<!-- Main -->
			<div id="main">
				...
				<div class="box container" >
					<section>
						<header>
							<h1>Registro de Factura de Compra</h1>
							<?php
							include('sqlServer/conexionP.php');

							$hoy = date(DATE_RFC2822);
						
							$sql = "INSERT into FACTURA_COMPRA (FECHA_FACTURAC, DESCRIPCION_FACTURAC, IMPUESTO,MONTOTOTAL_FACTURAC) values 
							('".$hoy."','".$_POST["descripcion"]."','".$_POST["impuesto"]."','".$_POST["montTotal"]."');";
	
							$stmt = sqlsrv_query( $conn, $sql );
							if( $stmt === false) {
								echo "Error al agregar la Factura de Compra"+print_r( sqlsrv_errors(), true);
							}else{
								echo "Se agrego la Factura de Compra correctamente";
							}
